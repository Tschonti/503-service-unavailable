...
public class Virologist {
    ...
    public void steal(Virologist v) {
        ...
        if (Initializer.questionWrite("Does the virologist that is trying to steal have space for more equipments?")  &&
                Initializer.questionWrite("Does the virologist that is being robbed have any equipments?")) {
